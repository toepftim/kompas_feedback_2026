...
const RATING_ITEMS = [
  ...
  { id: "entry.384231746", label: "Přínos příručky", notesId: "entry.1441280972" },
  ...
  { id: "entry.1387118574", label: "Vysvětlování pravidel (prodávání papírků)", notesId: "entry.1270461383" },
            ...
            {step === 1 && (
              <div className="space-y-12">
                <div className="text-center space-y-4 mb-12">
                  <h2 className="text-3xl md:text-4xl font-black uppercase text-white">Hodnocení různých částí Kompasu</h2>
                  <p className="text-emerald-400 font-bold uppercase tracking-widest text-xs md:text-sm">Dej nám svoje hodnocení pomocí posuvníku. Budeme rádi když nám napíšeš i pár slov abychom věděli co zlepšit.</p>
                </div>
                        ...
                        {item.notesId && (
                          <div className="space-y-2">
                            <label className="text-[10px] md:text-xs font-black text-stone-500 uppercase tracking-widest ml-1">
                              Poznámky k hodnocení <span className="text-emerald-600/50">(dobrovolné)</span>
                            </label>
                            <textarea
                              placeholder="Máš k tomu co říct?"
